...
size_t Vector::size() const { return data_.size(); }double Vector::dot(const Vector& other) const {
...
double& Vector::operator[](size_t index) { return data_.at(index); }const double& Vector::operator[](size_t index) const {
